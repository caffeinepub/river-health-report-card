...
export class Backend implements backendInterface {
    ...
    async getAllStations(): Promise<Array<StationData>> {
    ...
    async getStationReadings(arg0: string): Promise<StationData> {
        if (this.processError) {
            try {
                const result = await this.actor.getStationReadings(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
